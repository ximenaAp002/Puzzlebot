...
def build_model(is_cuda):
    net = cv2.dnn.readNetFromONNX("/home/ximena/Descargas/best.onnx")
    if is_cuda:
...
def load_classes():
    class_list = []
    with open("/home/ximena/Descargas/classes.txt", "r") as f:
...
is_cuda = len(sys.argv) > 2 and sys.argv[2] == "cuda"
